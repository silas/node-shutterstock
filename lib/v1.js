...
Shutterstock.prototype.registerCustomer = function(options, callback) {
  if (this.options.access_token) {
...
Shutterstock.prototype.getCustomerImageDownloads = function(options, callback) {
  if (typeof options === 'function') {
    callback = options;
    options = {};
  }
...
Shutterstock.prototype.getCustomerSubscriptions = function(options, callback) {
  if (typeof options === 'function') {
    callback = options;
    options = {};
  }
...
Shutterstock.prototype.getCustomerLightboxes = function(options, callback) {
  if (typeof options === 'function') {
    callback = options;
    options = {};
  }
